			...
			<table align="left" border="1">
				...
				<c:forEach items="${invoiceList}" var="invoice">
					<tr>
						...
						<td align="center">
							<a href="http://localhost:8080/InvoiceProject/invoice/edit?id=${invoice.id}">Edit</a> |
							<a href="http://localhost:8080/InvoiceProject/invoice/delete?id=${invoice.id}">Delete</a>
						</td>
					</tr>
				</c:forEach>
			</table>
